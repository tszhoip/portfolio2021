    ...
    <Container width={['100%', '100%', '100%', '80%']} flexDirection={['column', 'column', 'row', 'row']} p='4' flexWrap="no wrap" alignItems='start' justifyContent="center">
      ...
      <Wrap width={["100%", "100%", "50%", "50%"]} flexDirection='column' justifyContent="center">
        ...
        <Text fontFamily={[0]} color={['blk40']} variant='indentpb' fontSize={[1]}>
          Your privacy is important to us. It is Florian Karsten Typefaces' policy to respect your privacy regarding any information we may collect from you across our website, https://fonts.floriankarsten.com, and other sites we own and operate.
        </Text>
        ...
        <Text fontFamily={[0]} color={['blk40']} variant='indentpb' fontSize={[1]}>
          <Span color="#a5a5a5" paddingRight="16px">03</Span>This privacy policy only covers Florian Karsten Typefaces' own collecting and handling of data. We only work with partners, affiliates and third-party providers whose privacy policies align with ours, however we cannot accept responsibility or liability for their respective privacy practices.
